...
workflow council_four
  ...
  artifact judge_verdict json
    schema "schemas/council_synthesis_verdict.json"
  ...
  role synthesizer
    prompt template "templates/council_synthesizer.md" with council_brief, proposal_code, proposal_codex, proposal_kimi, proposal_deepseek
