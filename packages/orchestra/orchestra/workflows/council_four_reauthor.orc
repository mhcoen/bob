...
workflow council_four_reauthor
  ...
  artifact judge_verdict json
    schema "schemas/council_synthesis_verdict_reauthor.json"
  ...
  role synthesizer
    prompt template "templates/council_synthesizer_reauthor.md" with council_brief, proposal_code, proposal_codex, proposal_kimi, proposal_deepseek
