...
Missing evidence and provider failures block completion. Receipts retain the
review packet and its hash. `tests/test_task_review.py` covers packet validation
and failed reviews. Run-loop tests check command, legacy and batch completion.
